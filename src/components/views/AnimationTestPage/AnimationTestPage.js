...
/*
                <circle class="solarToGridSVG" r="2.5" fill="yellow" fill-opacity="0.8"></circle>
                <circle class="solarToGridSVG" r="7" fill="white" fill-opacity="0.2"></circle>
                <circle class="solarToHomeSVG" r="2.5" fill="blue" fill-opacity="0.8"></circle>
                <circle class="solarToHomeSVG" r="7" fill="white" fill-opacity="0.2"></circle>
                <circle class="solarToPowerwallSVG" r="2.5" fill="blue" fill-opacity="0.8"></circle>
                <circle class="solarToPowerwallSVG" r="7" fill="white" fill-opacity="0.2"></circle>
...
function AnimationTestPage() {
    ...
    const [SvgCurve1Visible, setSvgCurve1Visible] = useState("hidden")
    const [SvgCurve2Visible, setSvgCurve2Visible] = useState("hidden")
    const [SvgCurve3Visible, setSvgCurve3Visible] = useState("hidden")
    const [SvgCurve4Visible, setSvgCurve4Visible] = useState("hidden")
    const [SvgLine1Visible, setSvgLine1Visible] = useState("hidden")
    const [SvgLine2Visible, setSvgLine2Visible] = useState("hidden")

    const [SvgSolarVisible, setSvgSolarVisible] = useState("hidden")
    const [SvgSolarBoosterVisible, setSvgSolarBoosterVisible] = useState("hidden")
    const [SvgGridVisible, setSvgGridVisible] = useState("hidden")
    const [SvgGridBoosterVisible, setSvgGridBoosterVisible] = useState("hidden")
    const [SvgPowerwallVisible, setSvgPowerwallVisible] = useState("hidden")
    const [SvgPowerwallBoosterVisible, setSvgPowerwallBoosterVisible] = useState("hidden")
    ...
    //powerwall line : curve3 or curve4 or curve3/curve4
    ...
    useEffect(() => {
        ...
        if (SwitchState.checkedSolar === true) {                     // Solar : ON
            setSvgCurve1Visible("visible")                                      // curve1 on
            setSvgCurve2Visible("visible")                                      // curve2 on
            setSvgLine2Visible("visible")                                       // line2 on
            if (SwitchState.checkedBoosterMode === true) {           // Solar : ON, booster : ON
                setSvgSolarVisible("hidden")                                    // solar normal mode 감추고
                setSvgSolarBoosterVisible("visible")                            // solar booster mode 보이기
            }
            else if (SwitchState.checkedBoosterMode === false) {     // Solar : ON, booster : OFF
                setSvgSolarVisible("visible")                                   // solar normal mode 보이고
                setSvgSolarBoosterVisible("hidden")                             // solar booster mode 감추기
            } else {
                // none
            }
        }
            ...
            setSvgCurve1Visible("hidden")                                       // curve1 off
            setSvgCurve2Visible("hidden")                                       // curve2 off
            setSvgLine2Visible("hidden")                                        // line2 off
            setSvgSolarVisible("hidden")                                        // solar normal mode 감추기
            setSvgSolarBoosterVisible("hidden")                                 // solar booster mode 감추기
        }
        /// Grid ON
        if (SwitchState.checkedGrid === true) {                      // Grid : ON
            setSvgLine1Visible("visible")                                       // line1 on
            setSvgCurve3Visible("visible")                                      // curve3 on
            if (SwitchState.checkedBoosterMode === true) {           // Grid : ON, booster : ON
                console.log("여기true")
                setSvgGridVisible("hidden")                                    // grid normal mode 감추고
                setSvgGridBoosterVisible("visible")                            // grid booster mode 보이기
            }
            else if (SwitchState.checkedBoosterMode === false) {     // Grid : ON, booster : OFF
                console.log("여기타는지 확인!!!!!!!!!!!!!!!!!")
                setSvgGridVisible("visible")                                   // grid normal mode 보이고
                setSvgGridBoosterVisible("hidden")                             // grid booster mode 감추기
            } else {
                // none
            }
        } else {                                                     // Grid : OFF
            setSvgLine1Visible("hidden")                                       // line1 off
            setSvgCurve3Visible("hidden")                                      // curve3 off
            setSvgGridVisible("hidden")                                        // grid normal mode 감추기
            setSvgGridBoosterVisible("hidden")                                 // grid booster mode 감추기
        }
        /// Powerwall ON
        ...
        <div>
            <div class='background'>
                <svg width="360" height="480" viewBox="0 0 360 480" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle class="solarToGridSvg" r="2.5" fill="yellow" fill-opacity="0.8" visibility={SvgSolarVisible}></circle>
                    <circle class="solarToGridSvg" r="7" fill="white" fill-opacity="0.2" visibility={SvgSolarVisible}></circle>
                    <circle class="solarToHomeSvg" r="2.5" fill="blue" fill-opacity="0.8" visibility={SvgSolarVisible}></circle>
                    <circle class="solarToHomeSvg" r="7" fill="white" fill-opacity="0.2" visibility={SvgSolarVisible}></circle>
                    <circle class="solarToPowerwallSvg" r="2.5" fill="blue" fill-opacity="0.8" visibility={SvgSolarVisible}></circle>
                    <circle class="solarToPowerwallSvg" r="7" fill="white" fill-opacity="0.2" visibility={SvgSolarVisible}></circle>

                    <circle class="solarToGridSvgBooster" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToGridSvgBooster" r="15" fill="white" fill-opacity="0.2" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToHomeSvgBooster" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToHomeSvgBooster" r="15" fill="white" fill-opacity="0.2" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToPowerwallSvgBooster" r="3" fill="blue" fill-opacity="0.8" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToPowerwallSvgBooster" r="15" fill="white" fill-opacity="0.2" visibility={SvgSolarBoosterVisible}></circle>

                    <circle class="solarToGridSvgBoosterDuo" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToGridSvgBoosterDuo" r="15" fill="white" fill-opacity="0.2" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToHomeSvgBoosterDuo" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToHomeSvgBoosterDuo" r="15" fill="white" fill-opacity="0.2" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToPowerwallSvgBoosterDuo" r="3" fill="blue" fill-opacity="0.8" visibility={SvgSolarBoosterVisible}></circle>
                    <circle class="solarToPowerwallSvgBoosterDuo" r="15" fill="white" fill-opacity="0.2" visibility={SvgSolarBoosterVisible}></circle>

                    <circle class="gridToHomeSvg" r="2.5" fill="yellow" fill-opacity="0.8" visibility={SvgGridVisible}></circle>
                    <circle class="gridToHomeSvg" r="7" fill="white" fill-opacity="0.2" visibility={SvgGridVisible}></circle>
                    <circle class="gridToPowerwallSvg" r="2.5" fill="blue" fill-opacity="0.8" visibility={SvgGridVisible}></circle>
                    <circle class="gridToPowerwallSvg" r="7" fill="white" fill-opacity="0.2" visibility={SvgGridVisible}></circle>

                    <circle class="gridToHomeSvgBooster" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgGridBoosterVisible}></circle>
                    <circle class="gridToHomeSvgBooster" r="15" fill="white" fill-opacity="0.2" visibility={SvgGridBoosterVisible}></circle>
                    <circle class="gridToPowerwallSvgBooster" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgGridBoosterVisible}></circle>
                    <circle class="gridToPowerwallSvgBooster" r="15" fill="white" fill-opacity="0.2" visibility={SvgGridBoosterVisible}></circle>

                    <circle class="gridToHomeSvgBoosterDuo" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgGridBoosterVisible}></circle>
                    <circle class="gridToHomeSvgBoosterDuo" r="15" fill="white" fill-opacity="0.2" visibility={SvgGridBoosterVisible}></circle>
                    <circle class="gridToPowerwallSvgBoosterDuo" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgGridBoosterVisible}></circle>
                    <circle class="gridToPowerwallSvgBoosterDuo" r="15" fill="white" fill-opacity="0.2" visibility={SvgGridBoosterVisible}></circle>

                    <circle class="PowerwallToHomeSvg" r="2.5" fill="yellow" fill-opacity="0.8" visibility={SvgPowerwallVisible}></circle>
                    <circle class="PowerwallToHomeSvg" r="7" fill="white" fill-opacity="0.2" visibility={SvgPowerwallVisible}></circle>
                    <circle class="PowerwallToGridSvg" r="2.5" fill="blue" fill-opacity="0.8" visibility={SvgPowerwallVisible}></circle>
                    <circle class="PowerwallToGridSvg" r="7" fill="white" fill-opacity="0.2" visibility={SvgPowerwallVisible}></circle>

                    <circle class="PowerwallToHomeSvgBooster" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgPowerwallBoosterVisible}></circle>
                    <circle class="PowerwallToHomeSvgBooster" r="15" fill="white" fill-opacity="0.2" visibility={SvgPowerwallBoosterVisible}></circle>
                    <circle class="PowerwallToGridSvgBooster" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgPowerwallBoosterVisible}></circle>
                    <circle class="PowerwallToGridSvgBooster" r="15" fill="white" fill-opacity="0.2" visibility={SvgPowerwallBoosterVisible}></circle>

                    <circle class="PowerwallToHomeSvgBoosterDuo" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgPowerwallBoosterVisible}></circle>
                    <circle class="PowerwallToHomeSvgBoosterDuo" r="15" fill="white" fill-opacity="0.2" visibility={SvgPowerwallBoosterVisible}></circle>
                    <circle class="PowerwallToGridSvgBoosterDuo" r="3" fill="yellow" fill-opacity="0.8" visibility={SvgPowerwallBoosterVisible}></circle>
                    <circle class="PowerwallToGridSvgBoosterDuo" r="15" fill="white" fill-opacity="0.2" visibility={SvgPowerwallBoosterVisible}></circle>


                    <g id="frame_android">
                        <path id="curve1" d="M177 139C177 160.152 177 205.277 177 216.558C177 227.839 167.549 229.485 162.823 228.897H97" stroke="url(#paint0_linear)" visibility={SvgCurve1Visible} />
                        <path id="curve2" d="M183 139C183 160.152 183 205.277 183 216.558C183 227.839 192.451 229.485 197.177 228.897H263" stroke="url(#paint1_linear)" visibility={SvgCurve2Visible} />
                        <path id="curve3" d="M97 235C115.802 235 155.913 235 165.941 235C175.968 235 177.431 245.633 176.908 250.949L176.908 325" stroke="url(#paint2_linear)" visibility={SvgCurve3Visible} />
                        <path id="curve4" d="M183 325C183 303.848 183 258.723 183 247.442C183 236.161 192.451 234.515 197.177 235.103H263" stroke="url(#paint3_linear)" visibility={SvgCurve4Visible} />
                        <path id="line2" d="M180 139L180 325" stroke="url(#paint4_linear)" visibility={SvgLine2Visible} />
                        <path id="line1" d="M97 232L263 232" stroke="url(#paint5_linear)" visibility={SvgLine1Visible} />
                        <g id="dead_status">
                            ...
                            <g id="dead_solar">
                                <path id="Vector" fill-rule="evenodd" clip-rule="evenodd" d="M170.115 75.6234C172.29 75.6234 174.155 77.4883 174.155 79.8195C174.155 81.9952 172.29 83.8601 170.115 83.8601C167.783 83.8601 165.919 81.9952 165.919 79.8195C165.919 77.4883 167.783 75.6234 170.115 75.6234Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_2" d="M169.493 71.5828C169.493 70.8057 170.581 70.8057 170.581 71.5828V73.9139C170.581 74.691 169.493 74.691 169.493 73.9139V71.5828Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_3" d="M163.898 74.3802C163.277 73.7585 164.054 72.9815 164.675 73.6031L166.385 75.3126C166.851 75.7788 166.074 76.5559 165.608 76.0897L163.898 74.3802Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_4" d="M161.878 80.2857C161.101 80.2857 161.101 79.1978 161.878 79.1978H164.209C164.986 79.1978 164.986 80.2857 164.209 80.2857H161.878Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_5" d="M164.675 86.0358C164.054 86.502 163.277 85.725 163.898 85.1034L165.608 83.3939C166.074 82.9276 166.851 83.7047 166.385 84.3263L164.675 86.0358Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_6" d="M178.351 79.1978C178.973 79.1978 178.973 80.2857 178.351 80.2857H175.865C175.088 80.2857 175.088 79.1978 175.865 79.1978H178.351Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_7" d="M175.399 73.6031C176.02 72.9815 176.797 73.7585 176.331 74.3802L174.622 76.0897C174 76.5559 173.223 75.7788 173.689 75.3126L175.399 73.6031Z" fill="#C6C6C6" fill-opacity="0.5" />
                                ...
                                <path id="Vector_12" fill-rule="evenodd" clip-rule="evenodd" d="M172.852 94.0067H164.304L168.189 90.2769H175.804L172.852 94.0067Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_13" fill-rule="evenodd" clip-rule="evenodd" d="M181.399 94.0067H173.629L176.581 90.2769H183.419L181.399 94.0067Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_14" fill-rule="evenodd" clip-rule="evenodd" d="M190.413 94.0067H182.332L184.041 90.2769H191.19L190.413 94.0067Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_15" fill-rule="evenodd" clip-rule="evenodd" d="M199.893 90.2769V94.0067H191.345L191.967 90.2769H199.893Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_16" fill-rule="evenodd" clip-rule="evenodd" d="M192.744 86.3917H199.737V89.4998H192.122L192.744 86.3917Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_17" fill-rule="evenodd" clip-rule="evenodd" d="M185.906 86.3917H192.122L191.345 89.4998H184.507L185.906 86.3917Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector_18" fill-rule="evenodd" clip-rule="evenodd" d="M179.534 86.3917H185.44L183.73 89.4998H177.203L179.534 86.3917Z" fill="#C6C6C6" fill-opacity="0.5" />
                                <path id="Vector